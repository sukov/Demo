...
public class NotificationBanner: UIView {
	...
	private func addGestureRecognizers() {
		addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(NotificationBanner.didTap(_:))))
		let swipe = UISwipeGestureRecognizer(target: self, action: #selector(NotificationBanner.didSwipe(_:)))
		swipe.direction = .Up
	...
	private func adjustHeightOffset() {
		...
		if superview === NotificationBanner.topWindow() && self.position == .Top {
	...
	public func show(view: UIView? = NotificationBanner.topWindow(), duration: NSTimeInterval? = nil) {
